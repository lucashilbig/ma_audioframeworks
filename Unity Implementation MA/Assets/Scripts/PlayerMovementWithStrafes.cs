...
public class PlayerMovementWithStrafes : MonoBehaviour
{
    ...
    public Vector3 maxVelocity = new Vector3(100.0f, 100.0f, 100.0f);
    ...
    void Update()
    {
        ...
        velocity.x = (playerVelocity.x < maxVelocity.x) ? playerVelocity.x : maxVelocity.x;
        velocity.y = (playerVelocity.y < maxVelocity.y) ? playerVelocity.y : maxVelocity.y;
        velocity.z = (playerVelocity.z < maxVelocity.z) ? playerVelocity.z : maxVelocity.z;
